...
`Figwarapper` is a script that transforms the [Figma](https://www.figma.com/) design tool (web version) into an app for Linux. It uses a wrapper generated by [nativefier](https://github.com/jiahaog/nativefier) that is further customized to behave like a proper Linux app.
