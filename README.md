...
```bash
›_ git lfs install
›_ git clone https://github.com/cristianovitorino/figwrapper.git
›_ cd figwrapper
›_ chmod u+x InstallFigwrapper.sh
›_ sh ./InstallFigwrapper.sh
```

## Uninstall

```bash
›_ chmod u+x UninstallFigwrapper.sh
›_ sh ./UninstallFigwrapper.sh
```
