...
`Figwarapper` is script that transforms the [Figma](https://www.figma.com/) design tool (web version) into an app for Linux. It uses a wrapper generated by [nativefier](https://github.com/jiahaog/nativefier) that is further customized to behave like a proper Linux app.

<p align="center">
    <img src="https://raw.githubusercontent.com/cristianovitorino/figwrapper/master/Images/Screenshot.png"
    alt="screenshot"/>
</p>
<p style="text-align:center;"><i>Figma install through Figwrapper under i3-gaps on Fedora 31</i></p>
